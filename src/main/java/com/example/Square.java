...
public class Square extends JComponent {
    ...
    private MyCoolQueen occupyingPiece;
    ...
    public MyCoolQueen getOccupyingPiece() {
    ...
    public void put(MyCoolQueen p) {
        this.occupyingPiece = p;
    }
    
    public MyCoolQueen removePiece() {
        MyCoolQueen p = this.occupyingPiece;
